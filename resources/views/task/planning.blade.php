<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Perencanaan Tugas') }} - {{ Auth::user()->name }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('task.store') }}">
                        ...
                        <!-- Jenis Penugasan -->
                        <div class="mb-4">
                            <label for="assignment_type" class="block text-sm font-medium text-gray-700">Jenis
                                Penugasan</label>
                        ...
                        <!-- Komposisi Tim -->
                        <div class="mb-4">
                            <label for="team_composition" class="block text-sm font-medium text-gray-700">Komposisi
                                Tim</label>
                            ...
                            <div class="mb-4">
                                <label for="wakil_penanggung_jawab"
                                    class="block text-sm font-medium text-gray-700">Wakil Penanggung Jawab</label>
                            ...
                            <!-- Pengendali Teknis -->
                            <div class="mb-4">
                                <label for="pengendali_teknis"
                                    class="block text-sm font-medium text-gray-700">Pengendali Teknis</label>
                            ...
                            <!-- Anggota Tim -->
                            <div class="mb-4">
                                <label for="anggota_tim" class="block text-sm font-medium text-gray-700">Anggota
                                    Tim</label>
                        ...
                        <!-- Jumlah Hari -->
                        <div class="mb-4">
                            <label for="number_of_days" class="block text-sm font-medium text-gray-700">Jumlah
                                Hari</label>
                        ...
                        <div class="flex justify-end mt-4">
                            <button type="submit"
                                class="inline-flex justify-center py-3 px-6 border border-transparent rounded-lg shadow-lg text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                Simpan Perencanaan Tugas
                            </button>
                        </div>
                    </form>
