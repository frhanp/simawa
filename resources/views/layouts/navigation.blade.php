<aside class="h-full flex flex-col md:h-screen md:sticky md:top-0 bg-slate-50 border-r border-slate-200">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2">
        ...
        @if (Auth::check() && Auth::user()->role === 'admin')
            @php
                $isManajemenTugasActive = request()->routeIs('task.planning') || request()->routeIs('task.index') || request()->routeIs('task.edit');
            @endphp
            <div x-data="{ open: {{ $isManajemenTugasActive ? 'true' : 'false' }} }">
                ...
                >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-auto transform transition-transform" :class="{'rotate-180': open}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <x-nav-link :href="route('preparations')" :active="request()->routeIs('preparations')">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 14.5M14.25 3.104c.251.023.501.05.75.082M7.5 18.75a3 3 0 003-3H18a3 3 0 003-3V7.5a3 3 0 00-3-3h-2.25m-4.5 0H7.5a3 3 0 00-3 3v7.5a3 3 0 003 3z" />
                </svg>
        ...
        @if (Auth::check() && Auth::user()->role === 'inspektur')
            ...
            <x-nav-link :href="route('inspektur.orang.index')" :active="request()->routeIs('inspektur.orang.*')">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M15 21a6 6 0 00-9-5.197m0 0A4 4 0 119.5 9.172a4 4 0 01-3.5 3.555" />
                </svg>
